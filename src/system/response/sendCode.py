...
def send_email_smtp(verification_code, recipient) -> bool:
    ...
    try:
        ...
        logger.info(f"Send Email to {recipient} succ.")
        server.quit()
    except Exception as e:
        logger.error(f"Send Email to {recipient} fail: {str(e)}")
        return False
    return True
